...
public class HUD extends Module {
    ...
    public static Mode ArrayMode = new Mode("ArrayColorMode", ArrayModeE.values(), ArrayModeE.Rainbow);
    public static Mode ArrayFontMode = new Mode("ArrayFont", ArrayFont.values(), ArrayFont.Minecraft);
    ...
    public static Numbers<Double> g = new Numbers<>("Green", 155.0, 0.0, 255.0, 1.0);
    ...
    public static Numbers<Double> Arraybackground = new Numbers<>("ArrayAlpha", 0.0, 0.0, 255.0, 1.0);
    public static Mode logomode = new Mode("LogoMode", HUD.logomodeE.values(), logomodeE.Exhibition);
        ...
        if (customlogo.getValue()) {
            ...
            switch ((logomodeE) logomode.getValue()) {
                ...
                case Distance:
                    ...
                    dfont2.drawString(Client.Version, animLogoX + 2f, animLogoY + 24, new Color(255, 255, 255).getRGB());
                    //GL11.glDisable(3042);
                    break;
                case Jigsaw: {
                ...
                case Novoline: {
                    ...
                    xyz = "XYZ:" + " " + EnumChatFormatting.WHITE + MathHelper.floor_double(mc.thePlayer.posX)
                    ...
                    FontLoaders.SF18.drawStringWithShadow(xyz, new ScaledResolution(mc).getScaledWidth() / 250 - this.width,
                            new ScaledResolution(mc).getScaledHeight() - 9, colorXD);
                    FontLoaders.SF18.drawStringWithShadow(speedc, new ScaledResolution(mc).getScaledWidth() / 250 - this.width,
                            new ScaledResolution(mc).getScaledHeight() - 19, colorXD);
                    FontLoaders.SF18.drawStringWithShadow(fps, new ScaledResolution(mc).getScaledWidth() / 250 - this.width,
                            new ScaledResolution(mc).getScaledHeight() - 29, colorXD);
                ...
                case Exhibition:
                    name = "\247l" + Client.name.charAt(0);
                    String ok = Client.name.substring(1);
                    fps = EnumChatFormatting.GRAY + "[" + EnumChatFormatting.WHITE + Minecraft.getDebugFPS() + " FPS" + EnumChatFormatting.GRAY + "]";
                    mc.fontRendererObj.drawStringWithShadow(name, 3.0F, 3.0F, colorXD);
                    mc.fontRendererObj.drawStringWithShadow(ok + "", mc.fontRendererObj.getStringWidth(name) + 3.5F, 3.0F, new Color(255, 255, 255).getRGB());
                    mc.fontRendererObj.drawStringWithShadow(fps, mc.fontRendererObj.getStringWidth(name + ok),
                            3.0f, -1);
                    //GL11.glDisable(3042);
                    break;
            }
...
//                }
            ...
            if (mc.thePlayer != null) {
                ...
                if (this.info.getValue()) {
                    ...
                    if (!logomode.getValue().equals(logomodeE.Novoline) && !logomode.getValue().equals(logomodeE.Exhibition)) {
                        ...
                        font.drawStringWithShadow(EnumChatFormatting.GRAY + "FPS: " + EnumChatFormatting.WHITE + Minecraft.debugFPS + EnumChatFormatting.GRAY + " Ping: " + EnumChatFormatting.WHITE + pings
                                + " " + text2, 4.0, ScaledResolution.getScaledHeight() - ychat, Colors.WHITE.c);
                    }
