...
//						new Thread(() -> IRC.Verify(usernames, passwords)).start();
	...
	public void drawScreen(int var1, int var2, float var3) {
		...
		FontLoaders.GoogleSans16.drawString(Client.name + " made by \u00a7oTIQS\u00a7r (Foodtower Team)", width -
						FontLoaders.GoogleSans16.getStringWidth(Client.name+" made by \u00a7oTIQS\u00a7r (Foodtower Team)") - 1,
