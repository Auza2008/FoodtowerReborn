...
public class ItemRenderer {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        if (this.itemToRender != null) {
            ...
            } else if (abstractclientplayer.getItemInUseCount() > 0 || (itemToRender.getItem() instanceof ItemSword && (KillAura.fakeblockstatus || KillAura.blockingStatus || VanillaAura.blockingStatus))) {
